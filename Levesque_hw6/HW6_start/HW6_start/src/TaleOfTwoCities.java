 ...
 * HW 6, Problem 3
 * 
 * This has been modified to read from the file
 *  tale-of-two-cities.txt, including with this
 *  project.
 * 
 */
/*************************************************************************
...
public class TaleOfTwoCities
{
	...
	public static void main (String[] args)
	{
		...
		int minlen = 10; // Integer.parseInt(args[0]);
		ST<String, Integer> st = new ST<String, Integer>();
		
		In inFile = new In("tale-of-two-cities.txt");
