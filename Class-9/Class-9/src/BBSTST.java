 ...
 * <tt>equals()</tt> or <tt>hashCode()</tt>. The <em>put</em>, <em>contains</em>, <em>remove</em>, <em>minimum</em>, <em>maximum</em>, <em>ceiling</em>, and
 ...
 */
public class BBSTST<Key extends Comparable<Key>, Value> implements Iterable<Key>
{
	...
	{
		BBSTST<String, Integer> st = new BBSTST<String, Integer>();
