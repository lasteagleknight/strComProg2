/**
 * Exam 2, Problem 2: modify SortCompare to time and compare
 * 	the timings of the original Insertion sort and 
 *  your modified InsertionNoExchange sort
 */
/*************************************************************************
...
public class SortCompare
{
	...
	public static double time (String alg, Double[] a)
	{
		...
		if (alg.equals("Insertion"))
			Insertion.sort(a);
		else if (alg.equals("InsertionNoExchanges"))
	...
	/**
	 * The following test client will not be graded.
	 * 
	 * Instead, my JUnit tests will call the above timeRandomInput(...).
	 * 
	 * Only "Insertion" and "InsertionNoExchanges" will be passed for alg, 
	 * 	along with various values of N and T.
	 * 
	 * @param args
	 */
